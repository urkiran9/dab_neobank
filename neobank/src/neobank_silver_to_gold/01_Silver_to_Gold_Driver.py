...
# DBTITLE 1,Initialize widgets and parse parameters
import json
...
# DBTITLE 1,Create/update audit entry
...
# DBTITLE 1,Determine transformation notebook path
...
# DBTITLE 1,Run gold transformation notebook
status = "SUCCESS"
error_message = None
records = None
...
# DBTITLE 1,Update audit table with results
